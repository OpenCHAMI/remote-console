...
//   - /remote-console/consoles (Console operations)
//
// Route patterns:
//   - GET    /remote-console/consoles              -> List consoles
//
...
func registerResourcePrefixes() error {
	...
	resource.RegisterResourcePrefix("Console", "console")
...
func RegisterGeneratedRoutes(r chi.Router) {
	...
	r.Group(func(protected chi.Router) {
		...
		// Console routes
		protected.Route("/remote-console/consoles", func(r chi.Router) {
			r.Get("/", GetConsoles)
		})
